...
export class MigrationError extends Error {
  ...
  constructor(readonly reason: 'locked' | 'diverged', message: string) {
    super(message)
  }
}
...
export async function runMigrations(options: RunMigrationsOptions): Promise<MigrationOutcome> {
  ...
  const client = new pg.Client({ connectionString: options.connectionString, application_name: 'nerve-office-migrate' })
