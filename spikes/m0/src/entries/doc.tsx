...
import { p3DocBuilders } from '../experiments/p3-samples/doc-builders';
import { p5DocBuilders } from '../experiments/p5-samples/doc-builders';
...
createRoot(document.getElementById('root')!).render(
    <EditorShell profile={docProfile} defaultSample="minimal" createWorker={createWorker} builders={{ ...docBuilders, ...p3DocBuilders, ...p5DocBuilders }} />,
);
